...
def check_L_inflation_R2_spectral():
    ...
    return _result(
        ...
        cross_refs=[
            ...
            'T_particle',     # Admissibility potential (SSB onset)
        ],
        artifacts={
            'spectral_action_R2': {
...
def check_T_inflation():
    ...
    admissibility ledger drives an epoch of accelerated expansion
    ...
    PRE-INFLATIONARY STATE:
      ...
      The admissibility potential V(Phi) from T_particle has V(0) = 0
    ...
    END OF INFLATION:
      ...
      admissibility potential reaches its binding well at Phi/C ~ 0.73
    ...
    # ================================================================
    # The admissibility potential is unstable at Phi=0 (T_particle [P]):
...
def check_T_baryogenesis():
    ...
    Step 3 -- Generation routing dilution [T4E + L_self_exclusion, P]:
      ...
      d_eff = 102 effective admissibility states. The generations are
...
def check_T_reheating():
    ...
    STATEMENT: After the capacity fill (inflation), the admissibility
    ...
    margin absorbs ALL model-dependent uncertainties:
      ...
      (c) m_eff ~ omega * M_Pl ~ 2 * M_Pl. The admissibility potential
    ...
    """
    # ================================================================
    # Step 1: Admissibility potential parameters [T_particle, P]
    # ================================================================
    C = Fraction(1)
    eps = Fraction(1, 10)

    def V(phi):
        """Admissibility potential at saturation (eta/eps = 1)."""
        if phi >= C:
            return float('inf')
    ...
    return _result(
        ...
        summary=(
            f'UPGRADED [Ps]->[P] v5.0.3. '
            f'Admissibility well curvature d2V = {d2V_well:.2f} -> '
        ...
        dependencies=[
            'T_particle',    # Admissibility potential well + curvature [P]
...
def check_L_prediction_catalog():
    ...
    return _result(
        ...
        summary=(
            ...
            f'(m_ββ, Σmᵢ, r, N_e). '
            f'PLEC + IJC routing (Phase 19): zero free parameters; the four constitutive features (A1, MD, A2, BW) of admissibility space plus regime-specific structural premises (IJC at quantum-capable interfaces, KMS at thermodynamic, A9/Lovelock at gravitational) generate this breadth.'
        ),
        key_result=(
