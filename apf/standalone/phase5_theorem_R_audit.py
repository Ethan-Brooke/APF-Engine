...
def check_RT_R2_vectorlike_SSB():
    ...
    gap_description = (
        ...
        "(monogamy) requires independent admissibility channels."
    )

    defense = (
        "If gauge irreversibility is purely inherited from gravity, "
        "the gauge sector is not admissibility-independent (violates T_M). "
    ...
    return rt_result(
        ...
        summary=(
            ...
            f'admissibility independence. '
            f'RECOMMENDATION: Sharpen R2 to invoke T_M + admissibility '
        ...
        artifacts={
            ...
            'recommendation': (
                ...
                'irreversible channels -> admissibility independence (T_M) '
        ...
        attack_surfaces=[
            ...
            'AS-R2-2: Need explicit argument that admissibility independence '
...
def check_RT_R3_no_U1():
    ...
    # The correct argument is ADMISSIBILITY COMPLETENESS:
    #
    # A1 requires the admissibility structure to distinguish all physically
    ...
    rt_check(n_without < n_physical,
             "Without U(1): admissibility INCOMPLETE")
    ...
    return rt_result(
        ...
        summary=(
            ...
            f'The correct argument is ADMISSIBILITY COMPLETENESS: without U(1), '
            ...
            f'grading" but the real driver is admissibility completeness + '
        ...
        key_result=(
            ...
            'require U(1). Correct argument: admissibility completeness '
        ...
        artifacts={
            ...
            'correct_argument': (
                '(1) A1 requires admissibility completeness. '
            ...
            'code_gap': (
                ...
                'Should be "admissibility completeness + minimality." '
        ...
        attack_surfaces=[
            ...
            'as admissibility completeness argument.',
            'AS-R3-SUBTLE: Admissibility completeness assumes MATTER CONTENT '
...
if __name__ == '__main__':
    ...
    print("  R2: Sound but imprecise. Needs 'admissibility independence' not 'reversible.'")
    print("  R3: DERIVATION NEEDS REWRITING. Anomalies cancel without U(1).")
    print("      Correct argument: admissibility completeness + minimality.")
