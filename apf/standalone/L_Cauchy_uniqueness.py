...
THEOREM: The per-channel realignment cost function F: R+ → R+ is uniquely
...
Each condition is DERIVED from A1 (not assumed):
  ...
  C2 <- A1: more channels require more admissibility capacity
...
def check_L_Cauchy_uniqueness():
    ...
    return _result(
        ...
        key_result='F(d) = d unique (Cauchy 1821) [P] -> gamma = 17/4 -> sin^2 = 3/13 [P_structural: load not forced]',
