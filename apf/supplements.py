...
def check_T_spin_statistics():
    ...
    Step B3 [L_loc + L_irr -> microcausality, P]:
      L_loc (locality) requires that admissibility operations at
...
def check_T_CPT():
    ...
    Step 3 -- Hermiticity and spectral condition [T_Hermitian + T_particle, P]:
      T_Hermitian [P]: admissibility operators are Hermitian -> the
      Hamiltonian generating time evolution is Hermitian.
      T_particle [P]: the admissibility potential V(Phi) has a binding
...
def check_L_cluster():
    ...
    Step 1 -- Locality [L_loc, P]:
      Admissibility operations at spacelike-separated interfaces factorize.
    ...
    Step 2 -- Uniqueness of vacuum [T_particle + M_Omega, P]:
      The admissibility potential V(Phi) has a UNIQUE binding well
    ...
    admissibility at one interface does not consume capacity at a
    ...
    return _result(
        ...
        summary=(
            ...
            'Physical: admissibility at one interface does not consume '
        ...
        artifacts={
            ...
            'capacity_interpretation': (
                'L_loc: admissibility capacity at interface Gamma_A is '
                'independent of admissibility at distant Gamma_B. '
...
def check_T_BH_information():
    ...
    Step 1 -- Finite information content [T_Bek, P]:
      ...
      not in the "interior volume." This is because admissibility capacity
...
def check_L_naturalness():
    ...
    Step 2 -- Capacity regulates the sum [A1 + T_deSitter_entropy, P]:
      ...
      natural hierarchy. The admissibility potential V(Phi) has a well
    ...
    Step 4 -- No SUSY needed [T_Coleman_Mandula, P]:
      ...
      (b) Quadratic divergences are an artifact of pretending the
          ...
          has finitely many.
      (c) The physical mass is determined by the admissibility potential
    ...
    # More precisely: it comes from the admissibility potential shape
    ...
    return _result(
        ...
        dependencies=[
            ...
            'A1',               # Finite capacity
            'T_particle',       # Admissibility potential curvature
...
def check_L_beta_temp():
    ...
    is well-defined, positive, finite (epsilon = min admissibility quantum).
...
def check_L_TN_Hamiltonian():
    """L_TN_Hamiltonian: Realignment Cost as Uniform Graph Hamiltonian [P].

    Target 11 — Tensor Network Reformulation (Theorem 1 of 3).

    STATEMENT: The APF realignment cost Ω at Bekenstein saturation is
    ...
    Step 1 — Uniform cost per type [L_equip P]:
      ...
      contributes equally to the total realignment cost. Specifically,
    ...
    Step 2 — Binary admissibility [T_kappa P]:
    ...
    KEY INSIGHT — UNIFORM COST:
      ...
      structural property: realignment costs are type-additive
    ...
    kappa   = 2        # T_kappa [P]: binary admissibility
    ...
    # (realignment costs are additive at saturation by L_equip)
    ...
    return _result(
        name='L_TN_Hamiltonian: Realignment Cost = Uniform Graph Hamiltonian [P]',
        tier=4,
        epistemic='P',
        summary=(
...
def check_L_TN_product_state():
    ...
    SIGNIFICANCE — MINIMUM ENTANGLEMENT:
      ...
      at leading order. This is consistent with L_loc [P]: admissibility
...
def check_L_KMS_trace_state():
    ...
    PHYSICAL MEANING:
      ...
      unique temperature at which the realignment cost quantum ε* matches
      one modular unit:
...
def check_L_MERA_generation():
    ...
    MERA-APF DICTIONARY:
      ...
      | Bond dimension        | κ = 2 (binary admissibility, T_kappa)   |
...
def check_L_algebra_type():
    """L_algebra_type: APF Admissibility Algebra is Type I (Finite) → Type III₁ Limit [P].

    STATEMENT: The APF admissibility algebra has two natural descriptions
...
def check_L_ST_algebra():
    ...
    Step 4 — Direct sum structure:
      ...
      admissibility factorizes). Therefore the full gauge algebra on H_F decomposes
      as a direct sum:
...
def check_L_ST_Hilbert():
    ...
    INNER PRODUCT:
      ...
      fermionic sector of the admissibility algebra.
...
def check_L_ST_Dirac():
    ...
    The APF derives M_Y from comparison geometry:
...
def check_L_SA_moments():
    ...
    NORMALIZATION: The APF constructs M_s in internal admissibility units.
...
def check_L_SA_sector_dominance():
    ...
    The FN admissibility structure DERIVES this suppression — it is a consequence
    ...
    return _result(
        ...
        summary=(
            ...
            f'CCM spectral action prediction d/c^2->1/N_c holds because admissibility '
...
def check_L_SA_Higgs():
    ...
    The APF derives the sector scale ratio sv_d/sv_u = 1.887 from admissibility
    ...
    return _result(
        ...
        summary=(
            ...
            f'from comparison geometry (down double-VEV: M_d[2,2]={Md22:.1f} vs M_u[2,2]={Mu22:.3f}). '
...
def check_L_coupling_capacity_id():
    ...
    Step 1 [T20, P]:
      RG flow is realignment cost renormalization.  The inverse coupling
      ...
      information correspondence: α_i ↔ (realignment cost per interaction)⁻¹.
...
def check_L_QEC_code_space():
    """L_QEC_code_space: APF Admissibility Structure = Operator-Algebra QECC [P].

    v5.2.9 NEW.  Target 10 — Holographic Error Correction (Theorem 1 of 5).

    STATEMENT: The APF admissibility structure at Bekenstein saturation
    ...
    return _result(
        name='L_QEC_code_space: APF Admissibility = OA-QECC [P]',
        tier=4, epistemic='P',
        summary=(
...
def check_L_alpha_em():
    ...
    ALPHA(0) LINKED-GATE NOTE (verify-and-cite added 2026-05-26, v24.3.116):
      The running M_Z → q² = 0 (described above under RUNNING TO q² = 0) crosses
      the hadronic running Δα_had(M_Z), which is banked as
      [C_principled_external_universal_QCD_difficulty] in
      `apf/delta_alpha_leptonic.py:check_T_delta_alpha_had_principled_external_universal_QCD_C`
      (v24.3.116). Therefore α_em(0) = 1/137.036 inherits the same external
      status — it is NOT a clean first-principles APF prediction, only
      α_em(M_Z) = 1/128.21 is. The OS-W input inventory in
      `apf/sin2theta_w_OS_capacity_counting.py:check_T_M_W_tree_dimensionful_*`
      v24.3.115 was retro-corrected (2026-05-26) to split the alpha_em entry
      into alpha_em(M_Z) [P] and alpha_em(0) [C_principled_external] reflecting
      this linked-gate observation. The pQCD-at-M_Z multi-session sibling arc
      scoped at `APF Reference Docs/Reference - Sibling-AI Handoff Brief -
      Delta alpha_had pQCD at M_Z (2026-05-26).md` is the structural follow-on
      that, when closed, lifts the > Λ_match perturbative slice of both
      Δα_had AND α_em(0) to [P_perturbative_QCD_M_Z_first_principles].
    """
    from fractions import Fraction
...
def check_L_mu_mc_unified():
    """L_mu_mc_unified: Up-Sector m_u/m_c from Gram Crossing Geometry [form P; value P_structural].
    ...
    INPUTS (all [P]): L_upGram_PSD_saturation, L_upGram_schur_margin,
        L_crossing_self_energy, L_crossing_depletion_capacity_measure, L_channel_crossing, L_rank_lift, T_mass_ratios.
    NEW FREE PARAMETERS: 0
    STATUS: [P] (2026-06-02). The depletion weight xi=5/4 traces to L_crossing_self_energy [P] (xi = w2* = enforced SU(2)_L allocation, forced by type-exclusion) and the depletion factor (1 - c_Hu^2 w2*) is exact by additive capacity conservation (L_crossing_depletion_capacity_measure [P]). So this closes to [P]. Prediction m_u/m_c=0.0017 (0.4 sigma) unchanged.
    """
    import math
    import numpy as np
    ...
    print()
    print("L_mu_mc_unified [value P_structural -- load-inherited; mechanism P]")
    print("=" * 60)
    print()
    ...
    print()
    print("  STATUS: [value P_structural -- xi=w2*=5/4 inherits the [P_structural] EW load; mechanism P]. Within experimental uncertainty; depletion exact via additive capacity conservation (form [P]).")
    print()
    ...
    return _result(
        ...
        key_result=(
            f'm_u/m_c = {ratio_cross:.4f} from Gram crossing [value P_structural; load-inherited]; '
        ...
        dependencies=[
            ...
            'L_crossing_self_energy',
            'L_crossing_depletion_capacity_measure',
            'L_channel_crossing',
            'L_rank_lift',
            'T_mass_ratios',
            'L_Fisher_curvature',
...
def check_L_graviton_self_interaction():
    ...
    kappa_sq = 2  # T_kappa [P]: binary admissibility
...
def check_L_equivalence_principle():
    ...
    Step 1 [Uniform cost = equivalence]:
      From L_equip [P]: all 61 capacity types have equal admissibility
      cost ε*. In the semiclassical limit, realignment cost → energy.
...
def check_L_spacetime_emergence():
    ...
    emerges ENTIRELY from A1 (finite admissibility capacity) through
    ...
    WHAT IS ASSUMED:
    - A1: Finite admissibility capacity exists (C > 0, C < ∞)
...
def check_L_spatial_from_cost():
    """L_spatial_from_cost: Spatial Extension from Realignment Cost [P].
    ...
    them) is DERIVED from the realignment cost structure:
    ...
    (C) TOPOLOGY EXISTS — from sheaf structure (T_canonical [P]):
        ...
        admissibility patches together globally.
    ...
    (E) CONTINUUM EXISTS — from consistency (L_kolmogorov_internal [P]):
        At resolution ε, the lattice of admissibility loci has a unique
    ...
    (G) SPATIAL DYNAMICS — from gauge connection (T3 [P]):
        At each locus, local admissibility → local automorphism group.
        Continuity over the base space → principal G-bundle.
        Gauge connection = parallel transport of admissibility frames.
    ...
    C_total = 61
    kappa = 2
    epsilon = 1.0  # unit realignment cost
    s_1 = math.log(kappa)
    d = 4
    ...
    # The stalks = local admissibility algebras
    ...
    # admissibility frames between neighboring loci.
    ...
    return _result(
        name='L_spatial_from_cost: Spatial Extension from Realignment Cost',
        tier=5, epistemic='P',
        summary=(
            f'Spatial structure DERIVED from realignment cost (not entanglement). '
        ...
        artifacts={
            'mechanism': 'Realignment cost (NOT entanglement)',
...
def check_L_spacetime_emergence_v2():
    ...
    MECHANISM 2 — REALIGNMENT COST → DISTANCE AND SMOOTHNESS:
    ...
    return _result(
        ...
        summary=(
            ...
            f'(2) Realignment cost → metric + smooth manifold (L_cost → L_chartability). '
...
def check_L_Z_gauge_lattice():
    ...
    (A) SPATIAL LOCI from L_loc [P] + L_spatial_from_cost [P]:
        Admissibility distributes over N independent loci, forming a
        lattice Λ with spacing a ~ l_P (Planck scale).

    (B) GAUGE LINKS from T3 [P]:
        At each locus x, admissibility has a local automorphism group
        G = SU(3)×SU(2)×U(1). The gauge connection (parallel transport
        of admissibility frames between neighboring loci) assigns a
...
def check_L_full_quantum_theory():
    ...
    - Realignment cost → metric (L_cost → L_chartability)
...
def check_RT_QG_corruption():
    ...
    def qg_checks(C_total, kappa, eps_star, d):
        ...
        # Check 1: κ = 2 (binary admissibility, T_kappa)
        c1 = (kappa == 2)
...
def check_L_epsilon_star_Planck():
    ...
    STATEMENT
    ---------
    The minimum admissibility quantum ε* identified in L_epsilon* [P]
