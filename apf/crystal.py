...
_DEP_ALIASES: dict[str, str] = {
    ...
    "D-quotient": "D_quotient_forced",  # the hyphenated dep string of two core checks, normalised to the registered key; the D-quotient is a corollary of MD plus the declared OR0 clause (DQ1@2026-09-05), and it is not premised
}
