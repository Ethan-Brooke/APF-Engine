...
BANK_REGISTRY_MODULES: tuple[str, ...] = (
    ...
    "apf.ie_onboarding_registry",  # v24.3.307: Full Bank Onboarding Phase 1 -- the bank->IE coverage instrument (IE_DECLARATIONS contract + legacy fold-in + covers-credit + ratchet + extensibility witness); 1 bank check
