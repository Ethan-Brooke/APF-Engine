...
def check_T_up_family_apf_trace_vector() -> Dict[str, Any]:
    ...
    return {
        ...
        'passed': True,
        'epistemic': 'P_local',
        'branch_tag': 'B_GramToTrace strengthened',
        'codomain': 'APF_TRACE',
        'ratios': ratios,
...
IE_DECLARATIONS = (
    {
        ...
        "claim_text": (
            ...
            "[P_local, branch tag 'upstream-banking-ready'] proves the bridge theorem that "
            ...
            "covariance; check_T_up_family_apf_trace_vector [P_local, branch tag "
