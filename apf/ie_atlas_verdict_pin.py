"""APF IE Atlas verdict pin -- the tripwire snapshot (see PIN_VERSION below).
...
Data module: no checks, no logic. Generated by scripts/gen_ie_atlas_verdict_pin.py
from run_live_atlas at the version stamped in PIN_VERSION; the input-count
breakdown lives in the generator's console output at re-pin time.
"""
...
PINNED_VERDICTS = {
    ...
    "contextuality:native_ladder_bell_local": ("GLOBAL_SECTION_EXPORTED", True),
    "contextuality:native_ladder_chsh_violation": ("IJC_OBSTRUCTION", False),
    ...
    "ew:mcross_planck_ratio_reading": ("SOLVED_LOCAL_HELD_FOR_REPAIR", False),
    ...
    "ew:wg2_dictionary_typing_no_go": ("OBSTRUCTION_NAMED_CLOSURE", False),
    ...
    "foundation:agt_encoding_wall": ("OBSTRUCTION_NAMED_CLOSURE", False),
    "foundation:anchor_support_formalization": ("INTERNAL_IDENTITY_GLOBAL_P", True),
    ...
    "gauge:anchor_electric_center_correspondence": ("SOLVED_LOCAL_HELD_FOR_REPAIR", False),
    "gauge:beta_capacity_tiling": ("SOLVED_LOCAL_HELD_FOR_REPAIR", False),
    "gauge:colour_solder_form_no_go": ("OBSTRUCTION_NAMED_CLOSURE", False),
    ...
    "gauge:su2_string_cut_four_clause_verdict": ("SOLVED_LOCAL_HELD_FOR_REPAIR", False),
    ...
    "gravity:gammaC_carrier_watch": ("SOLVED_LOCAL_HELD_FOR_REPAIR", False),
    ...
    "quantum:frontend_closure_conditional_certificate": ("OBSTRUCTION_NAMED_CLOSURE", False),
    "quantum:ghz_mermin_state_independent": ("IJC_OBSTRUCTION", False),
    "quantum:held_holonomy_conditional_certificate": ("OBSTRUCTION_NAMED_CLOSURE", False),
    ...
    "strong:strong_cp_transport_content_blind": ("OBSTRUCTION_NAMED_CLOSURE", False),
