...
geometric). These are NOT additional PLEC components — APF's universal
frame is PLEC's four constitutive features (A1 + MD + A2 + BW) reading
admissibility space; these conditions are regime-specific structural
premises whose satisfaction closes the three-level diagram's subspace
slot at the relevant interface (parallel to IJC at quantum interfaces,
KMS at thermodynamic, A9/Lovelock at gravitational).
