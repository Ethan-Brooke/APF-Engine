"""APF -- Admissibility Physics Framework.

Release: __version__ below. Registered-check count: apf.bank.EXPECTED_REGISTRY_SIZE.

Zero free dimensionless parameters (one dimensional anchor: the Planck magnitude, equivalently the size of the de Sitter universe).
