...
| `quantum:frontend_closure_conditional_certificate` | ROUTE | OBSTRUCTION_NAMED_CLOSURE | Conditional Paper-5 front-end certificate. Soundness is separated from optional saturation; the named physical premise package is require... |
...
| `quantum:zipper_root_physicality_gate` | ROUTE | OBSTRUCTION_NAMED_CLOSURE | The exact zipper-root geometry is not consumed by the positivity proof. |
