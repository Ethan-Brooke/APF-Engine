#!/usr/bin/env python3
"""Targeted verifier for the W_TRACE row-bundle-to-component-sum bridge bank."""
from apf.w_trace_row_bundle_to_component_sum import CHECKS
...
def main() -> int:
    ...
    if failures:
        print("W_TRACE_ROW_BUNDLE_TO_COMPONENT_SUM_BRIDGE_BANK_FAIL")
        return 1
